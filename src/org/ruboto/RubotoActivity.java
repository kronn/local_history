...
public class RubotoActivity extends android.app.Activity {
  ...
  public static final int CB_CREATE_NAVIGATE_UP_TASK_STACK = 54;
  public static final int CB_NAVIGATE_UP = 55;
  public static final int CB_NAVIGATE_UP_FROM_CHILD = 56;
  public static final int CB_PREPARE_NAVIGATE_UP_TASK_STACK = 57;
  public static final int CB_APPLY_THEME_RESOURCE = 58;
  ...
  public void onCreateNavigateUpTaskStack(android.app.TaskStackBuilder arg0) {
    if (JRubyAdapter.isInitialized()) {
      if (callbackProcs != null && callbackProcs[CB_CREATE_NAVIGATE_UP_TASK_STACK] != null) {
        super.onCreateNavigateUpTaskStack(arg0);
        JRubyAdapter.runRubyMethod(callbackProcs[CB_CREATE_NAVIGATE_UP_TASK_STACK], "call" , arg0);
      } else {
        String rubyClassName = Script.toCamelCase(scriptName);
        if ((Boolean)JRubyAdapter.runScriptlet("defined?(" + rubyClassName + ") == 'constant' && " + rubyClassName + ".instance_methods(false).any?{|m| m.to_sym == :on_create_navigate_up_task_stack}")) {
          super.onCreateNavigateUpTaskStack(arg0);
          // FIXME(uwe): Simplify when we stop support for RubotoCore 0.4.7
          if (JRubyAdapter.isJRubyPreOneSeven()) {
            JRubyAdapter.put("$arg_arg0", arg0);
            ...
            if (JRubyAdapter.isJRubyOneSeven()) {
              JRubyAdapter.runRubyMethod(rubyInstance, "on_create_navigate_up_task_stack", arg0);
            } else {
              throw new RuntimeException("Unknown JRuby version: " + JRubyAdapter.get("JRUBY_VERSION"));
            }
          }
        } else {
          if ((Boolean)JRubyAdapter.runScriptlet("defined?(" + rubyClassName + ") == 'constant' && " + rubyClassName + ".instance_methods(false).any?{|m| m.to_sym == :onCreateNavigateUpTaskStack}")) {
            super.onCreateNavigateUpTaskStack(arg0);
            // FIXME(uwe): Simplify when we stop support for RubotoCore 0.4.7
            if (JRubyAdapter.isJRubyPreOneSeven()) {
              JRubyAdapter.put("$arg_arg0", arg0);
              ...
              if (JRubyAdapter.isJRubyOneSeven()) {
                JRubyAdapter.runRubyMethod(rubyInstance, "onCreateNavigateUpTaskStack", arg0);
              } else {
                throw new RuntimeException("Unknown JRuby version: " + JRubyAdapter.get("JRUBY_VERSION"));
              }
            }
  ...
  public boolean onNavigateUp() {
    if (JRubyAdapter.isInitialized()) {
      if (callbackProcs != null && callbackProcs[CB_NAVIGATE_UP] != null) {
        super.onNavigateUp();
        return (Boolean) JRubyAdapter.runRubyMethod(Boolean.class, callbackProcs[CB_NAVIGATE_UP], "call" );
      } else {
        String rubyClassName = Script.toCamelCase(scriptName);
        if ((Boolean)JRubyAdapter.runScriptlet("defined?(" + rubyClassName + ") == 'constant' && " + rubyClassName + ".instance_methods(false).any?{|m| m.to_sym == :on_navigate_up}")) {
          super.onNavigateUp();
          // FIXME(uwe): Simplify when we stop support for RubotoCore 0.4.7
          if (JRubyAdapter.isJRubyPreOneSeven()) {
            JRubyAdapter.put("$ruby_instance", rubyInstance);
            ...
            if (JRubyAdapter.isJRubyOneSeven()) {
              return (Boolean) JRubyAdapter.runRubyMethod(Boolean.class, rubyInstance, "on_navigate_up");
            } else {
              throw new RuntimeException("Unknown JRuby version: " + JRubyAdapter.get("JRUBY_VERSION"));
            }
          }
        } else {
          if ((Boolean)JRubyAdapter.runScriptlet("defined?(" + rubyClassName + ") == 'constant' && " + rubyClassName + ".instance_methods(false).any?{|m| m.to_sym == :onNavigateUp}")) {
            super.onNavigateUp();
            // FIXME(uwe): Simplify when we stop support for RubotoCore 0.4.7
            if (JRubyAdapter.isJRubyPreOneSeven()) {
              JRubyAdapter.put("$ruby_instance", rubyInstance);
              ...
              if (JRubyAdapter.isJRubyOneSeven()) {
                return (Boolean) JRubyAdapter.runRubyMethod(Boolean.class, rubyInstance, "onNavigateUp");
              } else {
                throw new RuntimeException("Unknown JRuby version: " + JRubyAdapter.get("JRUBY_VERSION"));
              }
            }
  ...
  public boolean onNavigateUpFromChild(android.app.Activity arg0) {
    if (JRubyAdapter.isInitialized()) {
      if (callbackProcs != null && callbackProcs[CB_NAVIGATE_UP_FROM_CHILD] != null) {
        super.onNavigateUpFromChild(arg0);
        return (Boolean) JRubyAdapter.runRubyMethod(Boolean.class, callbackProcs[CB_NAVIGATE_UP_FROM_CHILD], "call" , arg0);
      } else {
        String rubyClassName = Script.toCamelCase(scriptName);
        if ((Boolean)JRubyAdapter.runScriptlet("defined?(" + rubyClassName + ") == 'constant' && " + rubyClassName + ".instance_methods(false).any?{|m| m.to_sym == :on_navigate_up_from_child}")) {
          super.onNavigateUpFromChild(arg0);
          // FIXME(uwe): Simplify when we stop support for RubotoCore 0.4.7
          if (JRubyAdapter.isJRubyPreOneSeven()) {
            JRubyAdapter.put("$arg_arg0", arg0);
            ...
            if (JRubyAdapter.isJRubyOneSeven()) {
              return (Boolean) JRubyAdapter.runRubyMethod(Boolean.class, rubyInstance, "on_navigate_up_from_child", arg0);
            } else {
              throw new RuntimeException("Unknown JRuby version: " + JRubyAdapter.get("JRUBY_VERSION"));
            }
          }
        } else {
          if ((Boolean)JRubyAdapter.runScriptlet("defined?(" + rubyClassName + ") == 'constant' && " + rubyClassName + ".instance_methods(false).any?{|m| m.to_sym == :onNavigateUpFromChild}")) {
            super.onNavigateUpFromChild(arg0);
            // FIXME(uwe): Simplify when we stop support for RubotoCore 0.4.7
            if (JRubyAdapter.isJRubyPreOneSeven()) {
              JRubyAdapter.put("$arg_arg0", arg0);
              ...
              if (JRubyAdapter.isJRubyOneSeven()) {
                return (Boolean) JRubyAdapter.runRubyMethod(Boolean.class, rubyInstance, "onNavigateUpFromChild", arg0);
              } else {
                throw new RuntimeException("Unknown JRuby version: " + JRubyAdapter.get("JRUBY_VERSION"));
              }
            }
  ...
  public void onPrepareNavigateUpTaskStack(android.app.TaskStackBuilder arg0) {
    if (JRubyAdapter.isInitialized()) {
      if (callbackProcs != null && callbackProcs[CB_PREPARE_NAVIGATE_UP_TASK_STACK] != null) {
        super.onPrepareNavigateUpTaskStack(arg0);
        JRubyAdapter.runRubyMethod(callbackProcs[CB_PREPARE_NAVIGATE_UP_TASK_STACK], "call" , arg0);
      } else {
        String rubyClassName = Script.toCamelCase(scriptName);
        if ((Boolean)JRubyAdapter.runScriptlet("defined?(" + rubyClassName + ") == 'constant' && " + rubyClassName + ".instance_methods(false).any?{|m| m.to_sym == :on_prepare_navigate_up_task_stack}")) {
          super.onPrepareNavigateUpTaskStack(arg0);
          // FIXME(uwe): Simplify when we stop support for RubotoCore 0.4.7
          if (JRubyAdapter.isJRubyPreOneSeven()) {
            JRubyAdapter.put("$arg_arg0", arg0);
            ...
            if (JRubyAdapter.isJRubyOneSeven()) {
              JRubyAdapter.runRubyMethod(rubyInstance, "on_prepare_navigate_up_task_stack", arg0);
            } else {
              throw new RuntimeException("Unknown JRuby version: " + JRubyAdapter.get("JRUBY_VERSION"));
            }
          }
        } else {
          if ((Boolean)JRubyAdapter.runScriptlet("defined?(" + rubyClassName + ") == 'constant' && " + rubyClassName + ".instance_methods(false).any?{|m| m.to_sym == :onPrepareNavigateUpTaskStack}")) {
            super.onPrepareNavigateUpTaskStack(arg0);
            // FIXME(uwe): Simplify when we stop support for RubotoCore 0.4.7
            if (JRubyAdapter.isJRubyPreOneSeven()) {
              JRubyAdapter.put("$arg_arg0", arg0);
              ...
              if (JRubyAdapter.isJRubyOneSeven()) {
                JRubyAdapter.runRubyMethod(rubyInstance, "onPrepareNavigateUpTaskStack", arg0);
              } else {
                throw new RuntimeException("Unknown JRuby version: " + JRubyAdapter.get("JRUBY_VERSION"));
              }
            }
